...
export function WhatsAppButton({settings}:{settings:SiteSettings}) {
  ...
  return (
    <aside className="whatsapp-float-group" aria-label="WhatsApp quick chat options">
      <a
      ...
      >
        ...
        <span className="whatsapp-btn-text">Chat for <span className="whatsapp-btn-highlight">INQUIRY</span></span>
      </a>
      <a
        className="whatsapp-pill-btn"
        href={counselingHref}
      ...
      >
        ...
        <span className="whatsapp-btn-text">Chat for <span className="whatsapp-btn-highlight">COUNSELING</span></span>
      </a>
    </aside>
  );
}
